...
if "founded" in rfl:
    if "pran" in rfl:
        if "rfl" in rfl:
		        print("Major Genarel Amjad Khan Chowdhury")
		        talk("Major Genarel Amjad Khan Chowdhury")
elif "ceo" in rfl:
    print("Ahsan Khan Chowdhury")
    talk("Ahsan Khan Chowdhury")
elif "director" in rfl :
    print("Seema Chowdhury")
    talk("Seema Chowdhury")
elif "advisor" in rfl:
    print("Suprita Paul")
    talk("Suprita Paul")
